...
export default function Header() {
  ...
  return (
    <div className="top-0 py-1 lg:py-2 w-full fixed z-20 bg-transparent fixed z-10 dark:bg-gray-900 shadow-lg">
      <nav className="max-w-7xl mx-auto px-5 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-10">
          ...
          <Link href="/">
            <button className="focus:outline-none">
              <h2 className="text-white font-bold text-2xl hover:text-blue-500 transition duration-200">
                TrueDoc
              </h2>
            </button>
          </Link>
        ...
        <div className="hidden lg:block">
          <ul className="flex space-x-8 text-base font-semibold text-white">
            {["Home", "About", "Features", "Contact"].map((item) => (
              <li
                key={item}
                className="hover:underline hover:underline-offset-4 transition duration-200 hover:text-blue-500"
              >
