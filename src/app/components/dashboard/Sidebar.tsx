  ...
  return (
    <div className="flex flex-col items-center w-40 h-screen overflow-hidden text-gray-400 bg-gray-900 rounded">
      <a className="flex items-center w-full px-3 mt-3" href="#">
        ...
        <span className="ml-2 text-sm font-bold">TrueDoc</span>
      </a>
      <div className="w-full px-2">
        <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
          ...
          >
            ...
            <span className="ml-2 text-sm font-medium">Authority</span>
          </Link>
          <Link
            className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300"
            href="/docs"
          ...
          >
            ...
            <span className="ml-2 text-sm font-medium">Shareable</span>
          </Link>
        </div>
      </div>
      <Link
